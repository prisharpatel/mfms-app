...
const speakers = [
  ...
  },
  {
    ...
    description: 'Donni (Doniella) Davy is an 2 x Emmy winning makeup artist, makeup department head on HBO’s Euphoria, and founder of Half Magic, making her a trailblazer in the beauty, film, and entertainment industry. Donni is a household name in the beauty industry - and now, she’s returning to the set for Euphoria Season 3. She is not only celebrated for her groundbreaking work on the show, but she’s also gained recognition for her artistry with the biggest stars of the moment like Reneé Rapp, Mindy Kaling, and Chappell Roan, whose cultural impact has been monumental this year. Her innovative approach has redefined beauty standards in entertainment, igniting a global movement centered on self-expression and creativity. Ultimately, Donni’s impact is undeniable, with her digital presence skyrocketing 120% in Instagram impressions alone, plus a 31% increase in TikTok views between March and September 2024. As a department head of makeup on Euphoria, Donni oversees everything from the initial character designs to final application, making sure each look supports both the character’s emotional journey and the overall story. This includes not only the makeup but also special effects, prosthetics, and intricate details that define the show’s aesthetic. Every choice, from color palettes to bold eyeliner, is made with the camera in mind—ensuring each look is both visually striking and narratively meaningful. Donni has mastered the art of using makeup as a powerful storytelling tool, transforming it into a key element that helps define the show’s characters and amplify the emotional impact of the series.',
  },
  {
    id: '4',
    name: 'Jon Dinapoli',
    ...
    description: 'Jon Dinapoli, Founder and Chief Creative of Jon Michael Design, is a designer and leader with 25 years of experience in the luxury beauty and fashion industry. His vast experience spans a variety of designer, lifestyle, and celebrity brands, with a focus on multiple mediums and creative solutions. With formal training in graphic design and photography, he embodies the perfect blend of creativity, design, and strong business acumen. Jon Michael Design is a full-service creative agency specializing in branding, packaging, 2D and 3D design, strategy, digital, advertising, merchandising, and more. JMD collaborates with many brands in the fashion and celebrity space, with a primary focus on the beauty category.',
  },
  {
    id: '5',
    name: 'Daniel Jadczak',
    ...
    description: 'Daniel Jadczak, is a Chief Information Officer at LVMH Inc. North America region, and with an unlimited passion oversees all aspects of business-technology including OmniRetail, Data & AI, Infrastructure, CyberSecurity and Business Applications. Daniel has over 25 years of experience within the luxury tech field, with the last 16 at LVMH, showcasing a truly international experience, having worked in Asia, Europe and the US which has enriched his point of view on consumer behaviors and technology opportunities. Among many accomplishments, one stands out where Daniel spearheaded a business-tech program for Louis Vuitton brand, which aimed at implementing an OmniRetail POS system in 63 countries. Daniel’s professional brand can be seen as ‘adoptable leader’ or in other words ‘always ready to partner-up, if the stakes are clear and prioritized‘. When not preoccupied with some sort of transformational initiative, he can be found on a ski slope or at a helm of a sailboat.',
  },
  {
    id: '6',
