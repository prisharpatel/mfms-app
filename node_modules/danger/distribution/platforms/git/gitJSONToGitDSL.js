...
var jsonDiff = __importStar(require("rfc6902"));
...
exports.gitJSONToGitDSL = function (gitJSONRep, config) {
    var getFullDiff = config.getStructuredDiffForFile
        ? null
        : lodash_memoize_1.default(function (base, head) {
            return config.getFullDiff(base, head);
        }, function (base, head) { return base + "..." + head; });
    /**
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, diff.reduce(function (accumulator, _a) {
                            ...
                            var diff = {
                                after: jsonpointer_1.default.get(after, backAStepPath) || null,
                                before: jsonpointer_1.default.get(before, backAStepPath) || null,
                            };
                            var emptyValueOfCounterpart = function (other) {
                                if (Array.isArray(other)) {
                                    return [];
                                }
                                else if (lodash_isobject_1.default(diff.after)) {
                                    return {};
                                }
                                return null;
                            };
                            ...
                            if (Array.isArray(afterValue) && Array.isArray(beforeValue)) {
                                ...
                                diff.added = arrayAfter_1.filter(function (o) { return !lodash_includes_1.default(arrayBefore_1, o); });
                                diff.removed = arrayBefore_1.filter(function (o) { return !lodash_includes_1.default(arrayAfter_1, o); });
                                // Do the same, but for keys inside an object if they both are objects.
                            }
                            else if (lodash_isobject_1.default(afterValue) && lodash_isobject_1.default(beforeValue)) {
                                var beforeKeys_1 = lodash_keys_1.default(beforeValue);
                                var afterKeys_1 = lodash_keys_1.default(afterValue);
                                diff.added = afterKeys_1.filter(function (o) { return !lodash_includes_1.default(beforeKeys_1, o); });
                                diff.removed = beforeKeys_1.filter(function (o) { return !lodash_includes_1.default(afterKeys_1, o); });
                            }
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, Promise.all([
                        Promise.all(gitJSONRep.created_files.map(function (path) { return diffForFile(path); })),
                        Promise.all(gitJSONRep.modified_files.map(function (path) { return diffForFile(path); })),
                        Promise.all(gitJSONRep.deleted_files.map(function (path) { return diffForFile(path); })),
                    ])];
                case 1:
    ...
    var structuredDiffForFile = function (filename) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    diff = _a.sent();
                    fileDiffs = parse_diff_1.default(diff);
                    _a.label = 4;
                case 4:
    ...
    return {
        fileMatch: chainsmoker_1.default({
